...
from .views import HomePageView, SearchPageView, SchedulePageView, LoginPageView, DiscussionPageView, AccountCreated, home_page, signup, standings_tables, player_page, team_page, search_page, schedule_page, DefaultTeamsPageView
...
urlpatterns = [
    ...
    path("teams/", DefaultTeamsPageView.as_view(), name="teams"),
