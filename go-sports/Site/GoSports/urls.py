...
from .views import HomePageView, SearchPageView, SchedulePageView, LoginPageView, DiscussionPageView, AccountCreated, signup, standings_tables, player_page, team_page, search_page, schedule_page, DefaultTeamsPageView
